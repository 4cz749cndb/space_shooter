import type { ActionState, Enemy, EnemyProjectile, Projectile, SimulationEvent, Snapshot, Vector2 } from "./types";
...
export function createSpaceShooterSimulation() {
  ...
  const getTimeScale = () => clamp(1 + elapsedTime / 120, 1, maxTimeScale);
